...
<!------ Include the above in your HEAD tag ---------->
<link rel="stylesheet" href="src/webapp/WEB-INF/css/style.css">
        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="error-text">
                    ...
                    <h4>Oops! EL usuario no se encuentra en nuestra base de datos !</h4>
                    <p>Verifique si los datos son correctos</p>
                    <a href="login" class="btn btn-primary btn-round">Volver</a>
                </div>
            </div>
        </div>
    </div>
